"""
site_db.py - load and query the site database in resources/data/sites_db.json.
"""
...
from laitoxx.core.settings.paths import DATA_DIR

from .models import SiteEntry

_DEFAULT_DB_PATH = os.path.join(DATA_DIR, "sites_db.json")
