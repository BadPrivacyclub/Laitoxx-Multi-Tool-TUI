...
from laitoxx.features.crypto.hash_tools.rainbow_table_generator import rainbow_table_tool
...
from laitoxx.features.photo_geolocation.photo2geo import photo2geo_tool
...
TOOL_REGISTRY: dict[str, ToolSpec] = {
    ...
    "Port Scanner": ToolSpec(
        ...
        input_type=None,
        prompt=None,
        desc="Launch Zenmap for port scanning.",
        threaded=True,
    ),
    ...
    "Nmap": ToolSpec(
        ...
        input_type="nmap",
        prompt=None,
        desc="Run Nmap CLI and show a compact port/service report.",
        threaded=True,
    ),
    ...
    "Photo geolocation": ToolSpec(
        func=photo2geo_tool,
        input_type="photo2geo",
        prompt=None,
        desc="Photo geolocation via Netryx Astra: create/search local indexes and import/export/download bundles.",
        threaded=True,
    ),
}
